...
<Screenshot url="https://cloud.mongodb.com" src={"img/screenshots/20-mongodb-atlas/cluster-overview.png"} alt="Account creation form" />
...
<Screenshot url="https://cloud.mongodb.com" src={"img/screenshots/20-mongodb-atlas/load-sample-data.png"} alt="Account creation form" />

## Getting Your Connection String

<Screenshot url="https://cloud.mongodb.com" src={"img/screenshots/20-mongodb-atlas/connect.gif"} alt="Connection" />
